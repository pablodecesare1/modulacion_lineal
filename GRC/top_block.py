...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._ruido_win = GrRangeWidget(self._ruido_range, self.set_ruido, "ruido", "counter_slider", float, QtCore.Qt.Horizontal, "value")

        self.top_layout.addWidget(self._ruido_win)
        self._m_range = Range(0, 1, 0.1, 1, 200)
        self._m_win = GrRangeWidget(self._m_range, self.set_m, "m", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, m, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 10, 10, window.WIN_HAMMING, 6.76))
    ...
    def set_ruido(self, ruido):
        self.ruido = ruido
        self.channels_channel_model_0.set_noise_voltage(self.ruido)
